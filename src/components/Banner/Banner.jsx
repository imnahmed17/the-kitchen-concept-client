                ...
                <Row>
                    ...
                    <Col md={5}>
                        ...
                        <div className='mt-3'>
                            ...
                            <p className='justify'>Kitchen Concept is a website that offers a fresh perspective on kitchen design and functionality. Whether you're a professional chef or an amateur cook, Kitchen Concept provides innovative ideas and inspiration to help you create the perfect kitchen space for your needs.</p>
                        </div>
                    </Col>
                </Row>
            </Container>
